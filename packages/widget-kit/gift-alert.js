...
.bx-ga-kicker { font-family: var(--bx-font-display); font-size: clamp(9px,min(1.9cqi,3.7cqh),30px); letter-spacing: .5em;
...
.bx-ga-name { font-family: var(--bx-font-display); font-size: clamp(17px,min(5.4cqi,10.5cqh),86px); line-height: 1.04; margin-top: clamp(3px,2cqh,18px);
...
.bx-ga-gift { display: inline-block; margin-top: clamp(3px,2.4cqh,20px); padding: .3em 1.1em; font-family: var(--bx-font-display);
  font-size: clamp(12px,min(3.2cqi,6.3cqh),50px); text-transform: uppercase; letter-spacing: .04em; color: #0a0b10;
...
.bx-ga-coins { margin-top: clamp(4px,3cqh,26px); font-family: var(--bx-font-mono); font-weight: 700; font-size: clamp(12px,min(3.6cqi,7cqh),56px);
...
.bx-ga-neon .bx-ga-name { font-size: clamp(20px,min(8.4cqi,16.8cqh),130px); -webkit-text-stroke: 3px var(--bx-ink, #0a0b12); paint-order: stroke fill;
...
.bx-ga-neon .bx-ga-coins { font-size: clamp(15px,min(5cqi,10cqh),76px); -webkit-text-stroke: 2px var(--bx-ink, #0a0b12); paint-order: stroke fill; }
...
.bx-ga-banner .bx-ga-name { font-size: clamp(13px,min(3.4cqi,6.8cqh),52px); margin: 0; max-width: 45cqi; }
...
.bx-ga-banner .bx-ga-gift { margin: 0; font-size: clamp(10px,min(2.1cqi,4.2cqh),32px); padding: .25em .9em; }
.bx-ga-banner .bx-ga-coins { margin: 0 0 0 4px; font-size: clamp(12px,min(2.9cqi,5.8cqh),44px); }
